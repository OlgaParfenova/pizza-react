...
import { activateSort } from '../redux/slices/filterSlice';
        ...
        <div className='sort__popup'>
          <ul>
            {sortList.map((element, index) => (
              <li
                key={index}
                onClick={handleClickList(element)}
                className={sort.sortProperty === element.sortProperty ? 'active' : ''}>
                {element.name}
              </li>
            ))}
          </ul>
